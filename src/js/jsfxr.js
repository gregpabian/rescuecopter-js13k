...
function SfxrSynth() {
  ...
  this.synthWave = function ( buffer, length ) {
    ...
    for ( i = 0; i < length; i++ ) {
      ...
      buffer[ i ] = _superSample >= 1 ? 32767 : _superSample <= -1 ? -32768 : _superSample * 32767 |
        0;
    }
...
function jsfxr( settings ) {
  ...
  for ( ; i < used; i += 3 ) {
    ...
    output += base64Characters[ a >> 18 ] + base64Characters[ a >> 12 & 63 ] + base64Characters[ a >>
      6 & 63 ] + base64Characters[ a & 63 ];
  }
  return output;
}